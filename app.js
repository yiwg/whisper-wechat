//app.js
var apiconst=require("./utils/apiconst.js")
var stringUtils=require("./utils/stringUtils.js")
App({
  onLaunch: function () {
    console.log("whisper app start");
    this.getUserInfo(function(userInfo){
      console.log("there is userlogin......userInfo:"+userInfo.nickName);
      stringUtils.writeObj(userInfo)
      wx.request({
        url: apiconst.login,
        data: {
          userInfo:userInfo
        ...
        success: function(res){
          ...
          if(res.data.success==false){
            console.log("登录失败,code:"+res.data.code)
          }
          else{
            console.log("登录成功,code:"+res.data.code)
          }
        },
        fail: function() {
          console.log("网络请求失败")
